...
if __name__ == "__main__":
    ...
    yaml_list = [
        str(experiment_root / "inf_4d_123.yaml"),
        str(experiment_root / "16env_4d_sq123.yaml"),
        str(experiment_root / "inf_4d_123_nodata.yaml"),
        str(experiment_root / "inf_4d_sq.yaml"),
        str(experiment_root / "100env_4d_123.yaml"),
    ]
